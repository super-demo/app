...
class WorkspaceContents extends StatefulWidget {
  ...
  @override
  WorkspaceContentsState createState() => WorkspaceContentsState();
}
...
class WorkspaceContentsState extends State<WorkspaceContents> {
  ...
  void initState() {
    ...
    context.read<MiniAppBloc>().add(FetchSiteMiniAppList(siteId: workspaceId));
    context
        .read<WorkspaceBloc>()
        .add(FetchUserWorkspaces(parentSiteId: workspaceId));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      children: <Widget>[
        ...
        Padding(
          padding: const EdgeInsetsDirectional.only(top: 8.0, start: 16.0),
          child: Text(
            '${widget.workspaceName} \'s workspaces',
